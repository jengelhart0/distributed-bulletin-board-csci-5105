...
//    }
    ...
    public void testReadYourWritesSingleClient() throws IOException, NotBoundException {
        ...
        System.out.println("test client at server " + testClient.getServer().getThisServersIpPortString());
...
//        Thread.sleep(5000);
        System.out.println("test client moving to server at port " + serverPorts.get(1));
